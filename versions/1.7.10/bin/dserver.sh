...
$JAVA -server $JAVA_OPTS $JAVA_OPTS_SCRIPT $ORIENTDB_SETTINGS -Djava.util.logging.config.file="$LOG_FILE" -Dorientdb.config.file="$CONFIG_FILE" -Dorientdb.www.path="$WWW_PATH" -Dorientdb.build.number="UNKNOWN@r${buildNumber}; 2014-11-19 18:25:20+0000" -cp "$ORIENTDB_HOME/lib/orientdb-server-1.7.10.jar:$ORIENTDB_HOME/lib/*" com.orientechnologies.orient.server.OServerMain
