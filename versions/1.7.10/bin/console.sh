...
[ -f "$ORIENTDB_HOME"/lib/orientdb-tools-1.7.10.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
$JAVA -client $JAVA_OPTS $ORIENTDB_SETTINGS $SSL_OPTS -Dfile.encoding=utf-8 -Dorientdb.build.number="UNKNOWN@r${buildNumber}; 2014-11-19 18:25:20+0000" -cp "$ORIENTDB_HOME/lib/orientdb-tools-1.7.10.jar:$ORIENTDB_HOME/lib/*" com.orientechnologies.orient.graph.console.OGremlinConsole $*
